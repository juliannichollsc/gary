...
pnpm tauri dev
```
Benötigt Rust ≥ 1.96 + Node ≥ 18 + pnpm ≥ 9 (Windows: MSVC C++ Build Tools + WebView2). Siehe `CLAUDE.md` für die Build-Aufgabenliste und `docs/operating-rules.md` für die Methodik.
