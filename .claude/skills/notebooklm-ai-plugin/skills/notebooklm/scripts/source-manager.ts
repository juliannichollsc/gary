...
export async function deleteSource(
  ...
  // VERIFIED payload (live): DELETE_SOURCE (tGMBJ) takes the source id TRIPLE-nested: [[[sourceId]]].
  // The old [notebookId, [sourceId], [2]] returned [3] (error) and silently no-op'd → sources never deleted.
