...
pnpm tauri dev
```
Requer Rust ≥ 1.96 + Node ≥ 22.13 + pnpm ≥ 11 (Windows: MSVC C++ Build Tools + WebView2). Veja `CLAUDE.md` para a lista de tarefas do build e `docs/operating-rules.md` para a metodologia.
